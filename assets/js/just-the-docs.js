(function (jtd, undefined) {
    ...
    function initNavBar() {
      return fetch("https://wcerfgba.github.io/studying_economics/nav.html").then(function (response) {
    ...
    function initSearch() {
      ...
      request.open("GET", "https://wcerfgba.github.io/studying_economics/assets/js/search-data.json", true);
    ...
    jtd.setTheme = function (theme) {
      ...
      cssFile.setAttribute(
        "href",
        'https://wcerfgba.github.io/studying_economics/assets/css/just-the-docs-' + theme + ".css"
      );
    };
